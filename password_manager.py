...
class popupWindow(object):
    ...
    def __init__(self, master):
        ...
        self.l = Label(top, text=" Enter Password to unlock: ", font=('DengXian', 12), justify=CENTER)
        self.l.pack()
        self.e = Entry(top, show='*', width=30)
        self.e.pack(pady=7)
        self.b = Button(top, text='Confirm', command=self.cleanup, font=('DengXian', 11 ))
        self.b.pack()
...
class entity_display:
    ...
    def __init__(self, master, n, e, p, i):
        ...
        self.label_name = Label(self.window, text=dencryptedN, font=('DengXian', 12))
        self.label_email = Label(self.window, text=dencryptedE, font=('DengXian', 12))
        self.label_pass = Label(self.window, text=dencryptedP, font=('DengXian', 12))
...
def onsubmit():
    ...
    messagebox.showinfo('Added Account Info', 'Successfully Added, \n' + 'Name: ' + n + '\nEmail: ' + m + '\nPassword: ' + p)
    readfile()
...
entity_label = Label(window, text='Add Entity', font=('DengXian', 16))
email_label = Label(window, text='Site/App: ', font=('DengXian', 12, 'bold'))
name_label = Label(window, text='Username: ', font=('DengXian', 12, 'bold'))
pass_label = Label(window, text='Password: ', font=('DengXian', 12, 'bold'))
email = Entry(window, font=('DengXian', 14))
name = Entry(window, font=('DengXian', 14))
password = Entry(window, show='*', font=('DengXian', 14))
submit = Button(window, text='Add Account', command=onsubmit, font=('DengXian', 13))
...
name_label2 = Label(window, text='Name: ', font=('DengXian', 14))
email_label2 = Label(window, text='Email: ', font=('DengXian', 14))
pass_label2 = Label(window, text='Password: ', font=('DengXian', 14))
